...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"m-down","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!**********************************************************!*\
  !*** /Users/meishijian/Desktop/uniapp/m-down/pages.json ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!************************************************************************!*\
  !*** /Users/meishijian/Desktop/uniapp/m-down/uni.promisify.adaptor.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 49 */
/*!*************************************************************************************************!*\
  !*** /Users/meishijian/Desktop/uniapp/m-down/uni_modules/msj-down/components/msj-down/utils.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function formatTime(date, format) {
  var daDate = new Date(date.toString().length < 11 ? date * 1000 : date);
  var fromatsRule = ['y', 'm', 'd', 'h', 'i', 's'];
  var tmp = [];
  var year = daDate.getFullYear();
  var month = daDate.getMonth() + 1;
  var day = daDate.getDate();
  var hour = daDate.getHours();
  var minute = daDate.getMinutes();
  var second = daDate.getSeconds();
  if (format) {
...
function getRangeDate(v) {
  ...
  var nowWeekDay = now.getDay(); // 今天本周的第几天
  ...
  if (v === '-1') {
    ...
    var weekStart = new Date(nowYear, nowMonth, nowDay - nowWeekDay + 1);
    var weekEnd = new Date(nowTime + oneDay); // 今日
    dateRange.start = formatTime(weekStart, 'y-m-d');
    dateRange.end = formatTime(weekEnd, 'y-m-d');
    // 上周
  } else if (v === '-14') {
    var _weekStart = new Date(nowYear, nowMonth, nowDay - nowWeekDay - 6);
    var _weekEnd = new Date(nowYear, nowMonth, nowDay - nowWeekDay);
    dateRange.start = formatTime(_weekStart, 'y-m-d');
    dateRange.end = formatTime(_weekEnd, 'y-m-d');
    // 本月
  } else if (v === '-30') {
    var monthStart = new Date(nowYear, nowMonth, 1);
    var monthEnd = new Date(nowTime + oneDay);
    ...
    var lastMonthStart = new Date(nowYear, lastMonth, 1);
    var lastMonthEnd = new Date(nowYear, lastMonth, getMonthDays(lastMonth));
